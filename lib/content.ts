...
export const PIEZAS: Pieza[] = [
  ...
  },
  {
    ...
    titulo: "Roll for Cocktail — E.A.E.",
     ...
     ═══════════════════════════════════════════════════════════════ */
  {
    ...
    colaboradores: [{ nombre: "Jorge Raya", rol: "Rediseño del logotipo", url: "https://www.behance.net/jorgearayadu" }],
    destacado: true,
    orden: 7,
    media: { tipo: "ninguno" },
    galeria: 0,
     ...
     ═══════════════════════════════════════════════════════════════ */
  {
    ...
    colaboradores: [{ nombre: "Motif", rol: "Co-creación", url: "https://www.instagram.com/motif.fmx" }],
    destacado: true,
    orden: 8,
    media: { tipo: "ninguno" },
    galeria: 0,
  ...
  },
  {
    ...
    colaboradores: [{ nombre: "Motif", rol: "Edición de fotografía", url: "https://www.instagram.com/motif.fmx" }],
    destacado: false,
    orden: 9,
    media: { tipo: "ninguno" },
    galeria: 0,
